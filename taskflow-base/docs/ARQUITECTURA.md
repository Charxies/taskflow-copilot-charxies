...
Si quieres, genero un diagrama pequeño del flujo o un checklist de pruebas para el endpoint POST y lo agrego aquí. Las fechas límite se validan en la fábrica/constructor de la entidad `Task` (`src/main/java/com/taskflow/model/Task.java`), p.ej. `Task.crear(...)`.
